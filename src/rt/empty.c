...
int posix_spawnattr_init(posix_spawnattr_t*) { __builtin_trap(); }
int posix_spawnattr_destroy(posix_spawnattr_t*) { __builtin_trap(); }

int posix_spawnattr_setflags(posix_spawnattr_t*, short) { __builtin_trap(); }
int posix_spawnattr_getflags(const posix_spawnattr_t* __restrict, short* __restrict) {
    __builtin_trap();
}

int posix_spawnattr_setpgroup(posix_spawnattr_t*, pid_t) { __builtin_trap(); }
...
int posix_spawnattr_setschedpolicy(posix_spawnattr_t*, int) { __builtin_trap(); }
int posix_spawnattr_getschedpolicy(const posix_spawnattr_t* __restrict, int* __restrict) {
    __builtin_trap();
}

int posix_spawn_file_actions_init(posix_spawn_file_actions_t*) { __builtin_trap(); }
int posix_spawn_file_actions_destroy(posix_spawn_file_actions_t*) { __builtin_trap(); }

int posix_spawn_file_actions_addopen(posix_spawn_file_actions_t* __restrict, int,
                                     const char* __restrict, int, mode_t) {
    __builtin_trap();
}
int posix_spawn_file_actions_addclose(posix_spawn_file_actions_t*, int) { __builtin_trap(); }
int posix_spawn_file_actions_adddup2(posix_spawn_file_actions_t*, int, int) { __builtin_trap(); }
